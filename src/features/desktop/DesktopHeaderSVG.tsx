...
export const SVGComponent: FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ display: 'none' }}>
    <symbol id="window-control_close" viewBox="2.5 1 26 26">
      <line
        x1="19.5"
        y1="10.5"
        x2="10.5"
    ...
    <symbol id="window-control_minimize" viewBox="1 1 26 26">
      <line
        x1={10}
        y1="19.5"
        x2={20}
    ...
    <symbol id="window-control_discord" viewBox="2 1.5 26 26">
      <path
    ...
    <symbol id="social-email" viewBox="0 0 32 32">
      <path
        d="M6 11.5613L14.7505 18.5617C15.4809 19.1461 16.5188 19.1461 17.2493 18.5617L26 11.5612V21C26 21.5523 25.5523 22 25 22H7C6.44772 22 6 21.5523 6 21V11.5613Z"
        fill="currentcolor"
      />
      <path
        d="M6.32622 9.26106L15.9999 17L25.6737 9.26097C25.4959 9.09886 25.2595 9 25 9H7C6.74043 9 6.50396 9.0989 6.32622 9.26106Z"
        fill="currentcolor"
      />
        </symbol>
        <symbol id="user" viewBox="-7 -5 30 30">
            <path d="M7 8C11.2091 8 13 6.20914 13 4C13 1.79086 11.2091 0 9 0C6.79086 0 5 1.79086 5 4C5 6.20914 6.79086 8 9 8Z"
                fill="currentcolor"
        />
