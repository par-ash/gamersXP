...
export const Web3AuthProvider: FunctionComponent<IWeb3AuthState> = ({ children, web3AuthNetwork, chain }: IWeb3AuthProps) => {
  ...
  const setWalletProvider = useCallback(
    (web3authProvider: SafeEventEmitterProvider) => {
      ...
      const walletProvider = ethProvider(web3authProvider, uiConsole);
  ...
  useEffect(() => {
    ...
    async function init() {
      try {
        setIsLoading(true);
        const clientId = "BApuCibA7g9bIv0HoCRLhbUvo01ehy8Zn9INTc_CpkjtQTsHB3EMAPQBe9XW8vKaprjHOaW4Y4GvdFqBKOu1x9Q";
